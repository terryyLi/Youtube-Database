...
--------------------------------------------------
As a creator, I want to be a verified creator so users know I\'m not a fraudulent channel of other people. 
...
#------------------------------------------------------------
def verify_creator_menu():
    heading('As a creator, I want to be a verified creator so users know I\'m not a fraudulent channel of other people. \n Enter the creator id to get that creator verified.')
    creator_name = input('Creator name: ')
    showTableCreator()
    verify_creator(creator_name)
    showTableCreator()
...
def verify_creator(creator_name):
    query = '''
    UPDATE CREATOR
       SET isVerified = True
     WHERE name = %s
